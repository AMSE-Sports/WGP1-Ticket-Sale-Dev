...
const translations = {
  th: {
    ...
    visitorConfirmed:"ยืนยันผู้เข้าชมแล้ว", visitorSaved:"บันทึกผู้เข้าชมเรียบร้อยแล้ว", addVisitor:"ลงทะเบียนผู้ชมคนถัดไป", addVisitorHint:"เพิ่มผู้เข้าชมอีกหนึ่งคน", finishVisitors:"กรอกข้อมูลผู้ชมครบแล้ว", finishVisitorsHint:"ส่งคืนให้เจ้าหน้าที่เพื่อออกตั๋ว", removeLast:"ลบผู้ชมคนล่าสุด", staffNext:"ขั้นตอนถัดไปสำหรับเจ้าหน้าที่", handoverTitle:"การลงทะเบียนผู้ชมเสร็จสมบูรณ์", visitors:"ผู้เข้าชม", handoverBody:"ชำระเงินเรียบร้อยแล้ว กรุณาส่งอุปกรณ์คืนให้เจ้าหน้าที่เพื่อทำการออกตั๋วให้", staffContinue:"เจ้าหน้าที่ดำเนินการต่อ",
  ...
  zh: {
    ...
    visitorConfirmed:"观众已确认", visitorSaved:"观众资料已保存", addVisitor:"登记下一位观众", addVisitorHint:"添加另一位观众", finishVisitors:"所有观众已登记", finishVisitorsHint:"交还工作人员出票", removeLast:"删除最后一位观众", staffNext:"下一步：工作人员", handoverTitle:"观众登记已完成", visitors:"位观众", handoverBody:"付款已完成。请将设备交还工作人员，以便为您出票。", staffContinue:"工作人员继续",
  ...
  ja: {
    ...
    visitorConfirmed:"来場者確認済み", visitorSaved:"来場者情報を保存しました", addVisitor:"次の来場者を登録", addVisitorHint:"別の来場者を追加", finishVisitors:"全員の登録が完了", finishVisitorsHint:"発券のためスタッフへ返却", removeLast:"最後の来場者を削除", staffNext:"次はスタッフ", handoverTitle:"来場者登録が完了しました", visitors:"名", handoverBody:"お支払いは完了しています。チケット発券のため、端末をスタッフにお返しください。", staffContinue:"スタッフが続ける",
