...
const translations = {
  th: {
    ...
    privacyTitle:"ประกาศความเป็นส่วนตัวและสื่อภายในงาน", privacySubtitle:"ความเป็นส่วนตัวและสื่อภายในงาน", privacyRegistration:"<strong>การลงทะเบียนและจำหน่ายตั๋ว:</strong> WGP#1 เก็บข้อมูลที่จำเป็นเพื่อยืนยันตัวผู้เข้าชม บริหารตั๋ว วิเคราะห์จำนวนผู้ชม และรักษาความปลอดภัยภายในงาน โดยจัดเก็บตามระยะเวลาที่องค์กรกำหนดและให้สิทธิเจ้าของข้อมูลตามกฎหมาย", privacyMedia:"<strong>ภาพถ่ายและการถ่ายทอดสด:</strong> พื้นที่จัดการแข่งขันอาจมีการบันทึกภาพ เสียง และถ่ายทอดสดเพื่อรายงานการแข่งขันและประชาสัมพันธ์งาน", privacyAck:"ฉันได้อ่านและรับทราบประกาศความเป็นส่วนตัวและข้อมูลเกี่ยวกับสื่อภายในงาน", marketingConsent:"ฉันยินยอมรับข่าวสารการแข่งขันและกิจกรรมในอนาคตจาก WGP#1 (ไม่บังคับ)", marketingEmail:"อีเมลสำหรับรับข่าวสาร (ไม่บังคับ)", marketingEmailPlaceholder:"name@example.com", marketingEmailHint:"กรอกอีเมลหากต้องการให้ WGP#1 ส่งข่าวสารถึงคุณ โดยสามารถเว้นว่างได้", confirmVisitor:"ยืนยันข้อมูลผู้เข้าชมคนนี้",
  ...
  ja: {
    ...
    privacyTitle:"プライバシー通知・会場メディア", privacySubtitle:"プライバシーと会場メディア", privacyRegistration:"<strong>登録・発券：</strong> WGP#1 は本人確認、チケット管理、来場分析、会場の安全確保に必要な情報を取り扱います。データは組織の方針に従って保管され、本人は法的権利を行使できます。", privacyMedia:"<strong>撮影・ライブ配信：</strong> 大会報道や広報のため、会場内で写真撮影、録音、ライブ配信を行う場合があります。", privacyAck:"プライバシー通知と会場メディア情報を読み、内容を確認しました。", marketingConsent:"今後の WGP#1 ニュースや案内の受信に同意します（任意）。", marketingEmail:"ニュース受信用メール（任意）", marketingEmailPlaceholder:"name@example.com", marketingEmailHint:"WGP#1からの案内を希望する場合は入力してください。空欄でも登録できます。", confirmVisitor:"この来場者を確認",
