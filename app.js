...
const APP_CONFIG = {
  ...
  privacyNoticeVersion: "JWC26-DRAFT-02",
  ticketTypes: [
...
const translations = {
  th: {
    ...
    privacyTitle:"ประกาศความเป็นส่วนตัวและสื่อภายในงาน", privacySubtitle:"ความเป็นส่วนตัวและสื่อภายในงาน", privacyRegistration:"<strong>การลงทะเบียนและจำหน่ายตั๋ว:</strong> WGP#1 เก็บข้อมูลที่จำเป็นเพื่อยืนยันตัวผู้เข้าชม บริหารตั๋ว วิเคราะห์จำนวนผู้ชม และรักษาความปลอดภัยภายในงาน โดยจัดเก็บตามระยะเวลาที่องค์กรกำหนดและให้สิทธิเจ้าของข้อมูลตามกฎหมาย", privacyMedia:"<strong>การบันทึกภาพ วิดีโอ และเสียง:</strong> ผู้จัดงาน WGP#1 ช่างภาพ ผู้ผลิตสื่อ และผู้ได้รับมอบหมาย อาจบันทึกภาพนิ่ง ภาพเคลื่อนไหว และเสียงภายในงาน เพื่อนำไปใช้หรือเผยแพร่ผ่านสื่อต่าง ๆ สำหรับรายงานและประชาสัมพันธ์กิจกรรม", privacyAck:"ข้าพเจ้าได้อ่านประกาศความเป็นส่วนตัว และยินยอมให้ผู้จัดงาน WGP#1 รวมถึงช่างภาพ ผู้ผลิตสื่อ และผู้ได้รับมอบหมาย บันทึกภาพนิ่ง ภาพเคลื่อนไหว และเสียงของข้าพเจ้าภายในงาน และนำไปใช้หรือเผยแพร่ผ่านสื่อต่าง ๆ เพื่อรายงานและประชาสัมพันธ์กิจกรรมของ WGP#1", marketingConsent:"ฉันยินยอมรับข่าวสารการแข่งขันและกิจกรรมในอนาคตจาก WGP#1 (ไม่บังคับ)", marketingEmail:"อีเมลสำหรับรับข่าวสาร (ไม่บังคับ)", marketingEmailPlaceholder:"name@example.com", marketingEmailHint:"กรอกอีเมลหากต้องการให้ WGP#1 ส่งข่าวสารถึงคุณ โดยสามารถเว้นว่างได้", confirmVisitor:"ยืนยันข้อมูลผู้เข้าชมคนนี้",
  ...
  zh: {
    ...
    privacyTitle:"隐私声明与现场媒体", privacySubtitle:"隐私与现场媒体", privacyRegistration:"<strong>登记与售票：</strong> WGP#1 处理核实观众身份、管理门票、分析到场人数及保障活动安全所需的信息。数据依组织政策保留，数据主体可依法行使权利。", privacyMedia:"<strong>照片、视频和音频记录：</strong> WGP#1 主办方、摄影人员、媒体制作人员及其授权代表可能在活动现场拍摄照片、视频和录制音频，并通过各类媒体用于赛事报道和活动宣传。", privacyAck:"我已阅读隐私声明，并同意 WGP#1 主办方、摄影人员、媒体制作人员及其授权代表在活动现场拍摄和录制我的照片、视频及音频，并通过各类媒体用于 WGP#1 赛事报道和活动宣传。", marketingConsent:"我同意接收 WGP#1 未来赛事和活动资讯（可选）。", marketingEmail:"接收资讯的电子邮箱（选填）", marketingEmailPlaceholder:"name@example.com", marketingEmailHint:"如需接收 WGP#1 资讯，请填写电子邮箱；也可以留空。", confirmVisitor:"确认此观众资料",
    visitorConfirmed:"观众已确认", visitorSaved:"观众资料已保存", addVisitor:"登记下一位观众", addVisitorHint:"添加另一位观众", finishVisitors:"所有观众已登记", finishVisitorsHint:"交还工作人员出票", removeLast:"删除最后一位观众", staffNext:"下一步：工作人员", handoverTitle:"观众登记已完成", visitors:"位观众", handoverBody:"请将设备交还工作人员，以便为您发放入场票。", staffContinue:"工作人员继续",
  ...
  ja: {
    ...
    privacyTitle:"プライバシー通知・会場メディア", privacySubtitle:"プライバシーと会場メディア", privacyRegistration:"<strong>登録・発券：</strong> WGP#1 は本人確認、チケット管理、来場分析、会場の安全確保に必要な情報を取り扱います。データは組織の方針に従って保管され、本人は法的権利を行使できます。", privacyMedia:"<strong>写真・映像・音声の記録：</strong> WGP#1、撮影スタッフ、メディア制作担当者および正当に委任された者は、会場内で写真、映像および音声を記録し、大会の報道および広報を目的として各種媒体で使用・公開する場合があります。", privacyAck:"私はプライバシー通知を読み、WGP#1、撮影スタッフ、メディア制作担当者および正当に委任された者が、会場内で私の写真、映像および音声を記録し、WGP#1の大会報道および広報を目的として各種媒体で使用・公開することに同意します。", marketingConsent:"今後の WGP#1 ニュースや案内の受信に同意します（任意）。", marketingEmail:"ニュース受信用メール（任意）", marketingEmailPlaceholder:"name@example.com", marketingEmailHint:"WGP#1からの案内を希望する場合は入力してください。空欄でも登録できます。", confirmVisitor:"この来場者を確認",
    visitorConfirmed:"来場者確認済み", visitorSaved:"来場者情報を保存しました", addVisitor:"次の来場者を登録", addVisitorHint:"別の来場者を追加", finishVisitors:"全員の登録が完了", finishVisitorsHint:"発券のためスタッフへ返却", removeLast:"最後の来場者を削除", staffNext:"次はスタッフ", handoverTitle:"来場者登録が完了しました", visitors:"名", handoverBody:"入場チケットを発券するため、端末をスタッフにお返しください。", staffContinue:"スタッフが続ける",
  ...
  ko: {
    ...
    privacyTitle:"개인정보 안내 및 현장 미디어", privacySubtitle:"개인정보 및 현장 미디어", privacyRegistration:"<strong>등록 및 발권:</strong> WGP#1은 관람객 확인, 티켓 관리, 관람 분석 및 행사 안전에 필요한 정보를 처리합니다. 데이터는 조직 정책에 따라 보관되며 정보주체는 법적 권리를 행사할 수 있습니다.", privacyMedia:"<strong>사진·영상·음성 기록:</strong> WGP#1 주최자, 촬영 담당자, 미디어 제작자 및 위임받은 관계자는 행사 현장에서 사진, 영상 및 음성을 기록하고 행사 보도와 홍보를 위해 여러 매체에 사용하거나 공개할 수 있습니다.", privacyAck:"본인은 개인정보 안내를 읽었으며, WGP#1 주최자, 촬영 담당자, 미디어 제작자 및 위임받은 관계자가 행사 현장에서 본인의 사진, 영상 및 음성을 기록하고 WGP#1 행사 보도와 홍보를 위해 여러 매체에 사용하거나 공개하는 데 동의합니다.", marketingConsent:"향후 WGP#1 소식과 행사 안내 수신에 동의합니다(선택).", marketingEmail:"소식 수신 이메일(선택)", marketingEmailPlaceholder:"name@example.com", marketingEmailHint:"WGP#1 소식을 받고 싶다면 이메일을 입력하세요. 비워 두어도 됩니다.", confirmVisitor:"이 관람객 확인",
  ...
  fr: {
    ...
    privacyTitle:"Avis de confidentialité et médias", privacySubtitle:"Confidentialité et médias de l’événement", privacyRegistration:"<strong>Inscription et billetterie :</strong> WGP#1 traite les informations nécessaires à la vérification des visiteurs, à la gestion des billets, à l’analyse de fréquentation et à la sécurité. Les données sont conservées selon la politique de l’organisation et les personnes peuvent exercer leurs droits légaux.", privacyMedia:"<strong>Enregistrement photo, vidéo et audio :</strong> WGP#1, ses photographes, producteurs de médias et représentants autorisés peuvent enregistrer des photos, vidéos et sons pendant l’événement, puis les utiliser ou les diffuser sur différents médias à des fins d’information et de promotion de l’événement.", privacyAck:"J’ai lu l’avis de confidentialité et j’accepte que WGP#1, ses photographes, producteurs de médias et représentants autorisés enregistrent mon image, mes vidéos et ma voix pendant l’événement, puis les utilisent ou les diffusent sur différents médias pour informer et promouvoir les événements WGP#1.", marketingConsent:"J’accepte de recevoir les futures actualités et offres WGP#1 (facultatif).", marketingEmail:"E-mail pour les actualités (facultatif)", marketingEmailPlaceholder:"name@example.com", marketingEmailHint:"Saisissez votre e-mail pour recevoir les actualités WGP#1. Ce champ peut rester vide.", confirmVisitor:"Confirmer ce visiteur",
  ...
  es: {
    ...
    privacyTitle:"Aviso de privacidad y medios", privacySubtitle:"Privacidad y medios del evento", privacyRegistration:"<strong>Registro y entradas:</strong> WGP#1 trata la información necesaria para verificar visitantes, administrar entradas, analizar la asistencia y mantener la seguridad. Los datos se conservan según la política de la organización y las personas pueden ejercer sus derechos legales.", privacyMedia:"<strong>Grabación de fotografías, vídeo y audio:</strong> WGP#1, sus fotógrafos, productores de medios y representantes autorizados pueden grabar fotografías, vídeo y audio durante el evento y utilizarlos o publicarlos en distintos medios para informar y promocionar la actividad.", privacyAck:"He leído el aviso de privacidad y acepto que WGP#1, sus fotógrafos, productores de medios y representantes autorizados graben mi imagen, vídeo y audio durante el evento y los utilicen o publiquen en distintos medios para informar y promocionar las actividades de WGP#1.", marketingConsent:"Acepto recibir futuras noticias y ofertas de WGP#1 (opcional).", marketingEmail:"Correo para recibir noticias (opcional)", marketingEmailPlaceholder:"name@example.com", marketingEmailHint:"Introduce tu correo si quieres recibir noticias de WGP#1. Puedes dejarlo en blanco.", confirmVisitor:"Confirmar este visitante",
